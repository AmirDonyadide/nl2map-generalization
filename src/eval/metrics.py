...
def classification_metrics(
    ...
    *,
    ...
    """
    Compute standard classification metrics used in your thesis.

    Returns a dict with:
      - acc
      - f1_macro
      - confusion (as nested lists for JSON friendliness)
      - report (optional, classification_report output_dict=True)
    """
...
def regression_metrics(
    ...
    n = int(mask.sum())
    if n == 0:
        return {"n": 0.0, "MAE": float("nan"), "RMSE": float("nan")}
